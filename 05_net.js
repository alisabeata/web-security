...
// решение: разделение сети по уровню доверия (напр разделение по VLAN через свич, но физическое разделение даёт большую безопасность)
// так же можно уст прогр для защиты от сетевых атак с протоколом arp
